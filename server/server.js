...
// ─── CORS ─────────────────────────────────────
// In production, ALLOWED_ORIGIN should be your Vercel URL
// e.g. https://razatech.vercel.app
// Multiple origins can be comma-separated:
// ALLOWED_ORIGIN=https://razatech.vercel.app,https://www.razatech.com
...
// ─── FALLBACK ─────────────────────────────────
// In production (Railway), only the API runs here.
// The frontend is served from Vercel.
// Locally, serve the static site as a fallback.
app.get('*', (req, res) => {
  if (process.env.NODE_ENV === 'production') {
